...
import static battleStats.BattleStatsMod.makeCardPath;
...
public class CardTemplate extends AbstractDynamicCard {
    ...
    // public static final String ID = BattleStatsMod.makeID(${NAME}.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String ID = BattleStatsMod.makeID("DefaultCommonAttack"); // DELETE THIS ONE.
