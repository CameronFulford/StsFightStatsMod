...
public class DefaultCommonAttack extends CustomCard {
    ...
    public static final String ID = BattleStatsMod.makeID(DefaultCommonAttack.class.getSimpleName());
    ...
    // The list of all of them can be found in the main BattleStatsMod.java file in the
