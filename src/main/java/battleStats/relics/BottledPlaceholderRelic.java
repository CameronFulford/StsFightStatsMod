...
import battleStats.patches.relics.BottledPlaceholderField;
import battleStats.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static battleStats.BattleStatsMod.makeRelicOutlinePath;
import static battleStats.BattleStatsMod.makeRelicPath;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = BattleStatsMod.makeID("BottledPlaceholderRelic");
